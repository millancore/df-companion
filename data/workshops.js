/* Workshop metadata and artwork.
   ...
   `wiki` is the building's own article on the official wiki, printed as the
   bare URL on its page. This site says what a building makes; the exact job
   list, the version differences and every edge case live there, so the page
   points at the source rather than paraphrasing it. The quern's entry carries
   two, one for each of the buildings the card covers.
...
'Still': { kind: 'workshop', tier: 2, keys: 'b-o-f-l', img: 'still.png', box: '7.1 2.6 22.4 26.4', sw: 1.4,
  wiki: ['https://dwarffortresswiki.org/index.php/Still'],
...
'Quern or Millstone': { kind: 'workshop', tier: 2, keys: 'b-o-f-q',
  ...
  wiki: ['https://dwarffortresswiki.org/index.php/Quern',
         'https://dwarffortresswiki.org/index.php/Millstone'],
...
'Screw Press': { kind: 'workshop', tier: 2, keys: 'b-o-R',
  ...
  wiki: ['https://dwarffortresswiki.org/index.php/Screw_press'],
...
'Fishery': { kind: 'workshop', tier: 1, keys: 'b-o-f-y', img: 'fishery.png', box: '2.6 9.4 26.8 13.3', sw: 1.42,
  wiki: ['https://dwarffortresswiki.org/index.php/Fishery'],
...
"Dyer's Shop": { kind: 'workshop', tier: 3, keys: 'b-o-l-y', img: 'dyer.png', box: '4.6 3.2 22.8 24.2', sw: 1.29,
  wiki: ['https://dwarffortresswiki.org/index.php/Dyer%27s_shop'],
...
"Clothier's Shop": { kind: 'workshop', tier: 3, keys: 'b-o-l-k', img: 'clothier.png', box: '4.6 5.6 22.8 21.8', sw: 1.21,
  wiki: ['https://dwarffortresswiki.org/index.php/Clothier%27s_shop'],
...
'Ashery': { kind: 'workshop', tier: 2, keys: 'b-o-y', img: 'ashery.png', box: '6.6 8.6 18.8 24.1', sw: 1.28,
  wiki: ['https://dwarffortresswiki.org/index.php/Ashery'],
...
"Soap Maker's Workshop": { kind: 'workshop', tier: 3, keys: 'b-o-P', img: 'sopamarker.png', box: '3.6 4 27.9 21.4', sw: 1.48,
  wiki: ['https://dwarffortresswiki.org/index.php/Soap_maker%27s_workshop'],
...
"Mason's Workshop": { kind: 'workshop', tier: 1, keys: 'b-o-t', img: 'stoneworker.png', box: '2.6 4.6 26.8 22.8', sw: 1.42,
  wiki: ['https://dwarffortresswiki.org/index.php/Stoneworker%27s_workshop'],
...
"Mechanic's Workshop": { kind: 'workshop', tier: 1, keys: 'b-o-h', img: 'mechanic.png', box: '4.6 4.6 22.8 22.8', sw: 1.21,
  wiki: ['https://dwarffortresswiki.org/index.php/Mechanic%27s_workshop'],
...
"Craftsdwarf's Workshop": { kind: 'workshop', tier: 1, keys: 'b-o-r', img: 'craftsdwarf.png', box: '0 0 256 256', sw: 1.35,
  wiki: ['https://dwarffortresswiki.org/index.php/Craftsdwarf%27s_workshop'],
...
"Bowyer's Workshop": { kind: 'workshop', tier: 1, keys: 'b-o-b', img: 'bowyer.png', box: '0 0 24 24', sw: 1.5,
  wiki: ['https://dwarffortresswiki.org/index.php/Bowyer%27s_workshop'],
...
'Clay soil': { kind: 'place', box: '2.6 12.6 26.8 14.8', sw: 1.42,
  note: 'Collect clay from a soil layer, ordered at the kiln and carried out by any hauler. Like sand the tile never runs out — kaolinite, which has to be mined, is the one ceramic material that does.',
  art: `<path d="M4 26h24"/><path d="M4 21q6-4 12 0t12 0"/>
        <path d="M10 21c0-4 2.7-7 6-7s6 3 6 7z" class="ac"/>` },
